...
func NewRouter(todoDB *sql.DB) *http.ServeMux {
	...
	mux.HandleFunc("/todos", middleware.Recovery(middleware.StoreOSName(middleware.Log(middleware.BasicAuth(handler.NewTODOHandler(service.NewTODOService(todoDB)))))).ServeHTTP)
